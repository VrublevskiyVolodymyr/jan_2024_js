...
divElement.style.background = 'cornflowerblue';
divElement.style.color = 'darkblue';
divElement.style.fontSize = '25px';
divElement.style.height = '100px';
divElement.style.margin = '10px';
divElement.innerText = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti ea iste necessitatibus nulla.';
...
for (const element of coursesAndDurationArray) {
    ...
    item.append(h1Element, pElement);
...
let containerSimpson = document.createElement('div');
containerSimpson.classList.add('containerSimpson');
document.body.appendChild(containerSimpson);
...
for (const simpson of simpsons) {
    ...
    simpsonElement.append(h2Name, h2Surname, h3Surname, pInfo, img);
    containerSimpson.appendChild(simpsonElement);
}
// =========================
//     Цикл в циклі
...
let coursesArrayContainer = document.createElement('div');
coursesArrayContainer.classList.add('coursesArrayContainer');
document.body.appendChild(coursesArrayContainer);

for (const course of coursesArray) {
    let blockElement = document.createElement('div');
    blockElement.classList.add('blockElement');
    coursesArrayContainer.appendChild(blockElement);
    ...
    for (const key in course) {
        ...
        switch (key) {
            case 'monthDuration': {
                ...
                durationElement.classList.add('month');
                durationElement.innerText = `${key}: ${course[key]}`;
            ...
            case 'hourDuration': {
                let durationElement = document.createElement('div');
                durationElement.classList.add('hour');
                durationElement.innerText = `${key}: ${course[key]}`;
                duration.appendChild(durationElement);
            }
                blockElement.appendChild(duration);
                break;
            ...
            case 'modules': {
                ...
                for (const element of course[key]) {
            ...
            case 'title': {
                ...
                element.innerText = ` ${key}: ${course[key]}`
                blockElement.appendChild(element);
            }
                break;
        }
