...
const area_triangle = (a, b) => a * b;

console.log('area_triangle= ' + area_triangle(3, 4));
console.log("**********************************************************************")

// - створити функцію яка обчислює та повертає площу кола з радіусом r
const area_circle = r => (Math.PI * r * r).toFixed(2);

console.log('area_circle= ' + area_circle(5));
console.log("**********************************************************************")

// - створити функцію яка обчислює та повертає площу циліндру висотою h, та радіутом r
const area_cylinder = (h, r) => (2 * Math.PI * r * h + 2 * Math.PI * r * r).toFixed(2);
...
const printerArrayObject = array => {
